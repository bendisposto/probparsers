...
public class ToAsciiTest {
	...
	{
		// XXX really intended!?
		assertTrue(UnicodeTranslator.toAscii("!(z).(P => Q)").equals("!(z).(P => Q)"));
		assertTrue(UnicodeTranslator.toAscii("\u2200(z)\u00b7(P \u21d2 Q)").equals("!(z).(P => Q)"));
	}
	...
	/* de.prob.unicode.lexer.LexerException: [1,1] Unknown token: [
	 * '[' not permitted
	 */
	@Ignore
	...
	{
		assertTrue(UnicodeTranslator.toAscii("{z \u00b7 P \u2223 F}").equals("{z . P | F}"));
	}
...
//	XXX NonEmptySubsets not provided? What's the unicode character? \u2119 and \u2081
	@Test
...
//	XXX FiniteSets not provided? http://wiki.event-b.org/images/EventB-Summary.pdf
...
//	XXX FiniteNonEmptySubsets not provided? What's the unicode character? \u1D53D and \u2081 ?
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("partition(S,x,y)").equals("partition(S,x,y)"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("\u22c3 (z)\u00b7(P \u2223 E)").equals("UNION (z).(P | E)"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("\u22c3 z\u00b7P \u2223 S").equals("UNION z.P | S"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("\u22c2 (z)\u00b7(P \u2223 E)").equals("INTER (z).(P | E)"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("\u22c2 z\u00b7P \u2223 S").equals("INTER z.P | S"));
	}	
...
//	XXX PositiveNaturalNumbers not provided? \u2115 and \u2081
	...
	public void SetSummation()
	{
		...
		assertTrue(UnicodeTranslator.toAscii("SIGMA(z)\u00b7(P \u2223 E)").equals("SIGMA(z).(P | E)"));
	}
	...
	{
		// XXX PI not provided (\u220F)
		assertTrue(UnicodeTranslator.toAscii("PI(z)\u00b7(P \u2223 E)").equals("PI(z).(P | E)"));
	}
	...
	/* FIXME UnicodeTranslator.toAscii("p ; q") makes "p , q"
	 */
	@Test
	...
	/* de.prob.unicode.lexer.LexerException: [1,2] Unknown token: [
	 * '[' not permitted
	 */
	@Ignore
	...
	/* XXX java.io.IOException: Pushback buffer overflow
	 * LeftOverriding not provided? How to escape '+>' ?
	 */
	@Test
	public void LeftOverriding()
	{
		assertTrue(UnicodeTranslator.toAscii("r1 +> r2").equals("r1 +> r2"));
//		assertTrue(UnicodeTranslator.toAscii("r1 +\\> r2").equals("r1 +\\> r2")); 	// makes "r1 +\> r2", that's not correct
	}
...
//	XXX Iteration not provided? something like r^n
	...
	{
		assertTrue(UnicodeTranslator.toAscii("iterate(r,n)").equals("iterate(r,n)"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("rclosure(r)").equals("rclosure(r)"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("iclosure(r)").equals("iclosure(r)"));
	}
	...
	/*XXX Projection not provided? But how to translate '2'? Take the whole 'prj2'.
	 */
	@Test
...
//	XXX TotalSurjections not provided? What's the unicode character? \u21A0
	...
	{
		assertTrue(UnicodeTranslator.toAscii("\u03bbz\u00b7(P\u2223E)").equals("%z.(P|E)"));
	}	
	...
	{
		assertTrue(UnicodeTranslator.toAscii("f(E \u21a6 F)").equals("f(E |-> F)"));
	}	
...
//	XXX FiniteNonEmptySequences not provided? What's the unicode character?
	...
	/* XXX java.io.IOException: Pushback buffer overflow
	 * PrependElement not provided? How to escape '->' ?
	 * What's the unicode character? \u2192
	 */
	@Test
	public void PrependElement()
	{
		assertTrue(UnicodeTranslator.toAscii("E -> s").equals("E -> s"));
//		assertTrue(UnicodeTranslator.toAscii("E -\\> s").equals("E -\\> s"));	// makes "E -\> s", that's not correct
	}	
	
	/* XXX java.io.IOException: Pushback buffer overflow
	 * AppendElement not provided? How to escape '<-' ?
	 * What's the unicode character? \u2190
	 */
	@Test
...
//		assertTrue(UnicodeTranslator.toAscii("s <\\- E").equals("s <\\- E")); 	// makes "s <\- E", that's not correct
	}	
	...
	/* de.prob.unicode.lexer.LexerException: [1,4] Unknown token: |\
	 * What's the unicode character? \u2191
	 * Take not provided.
	 */
	@Ignore
	...
	{
		assertTrue(UnicodeTranslator.toAscii("x := bool(P)").equals("x := bool(P)"));
	}		
	...
	/* FIXME UnicodeTranslator.toAscii("G ; H") makes "G , H"
	 */		
	@Test
...
//	XXX Guarding not provided? What's the unicode character? \u21D2
	...
	/* de.prob.unicode.lexer.LexerException: [1,3] Unknown token: [
	 * '[' not permitted
	 */
	@Ignore
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc123FALSE").equals("abc123FALSE"));
		assertTrue(UnicodeTranslator.toAscii("abc123false").equals("abc123false"));
	}
	@Test
	public void LetterDigitINTEGER()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123INTEGER").equals("abc123INTEGER"));
		assertTrue(UnicodeTranslator.toAscii("abc123integer").equals("abc123integer"));
	}
	@Test
	public void LetterDigitINTER()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123INTER").equals("abc123INTER"));
		assertTrue(UnicodeTranslator.toAscii("abc123inter").equals("abc123inter"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc123NATURAL").equals("abc123NATURAL"));
		assertTrue(UnicodeTranslator.toAscii("abc123natural").equals("abc123natural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc123UNION").equals("abc123UNION"));
		assertTrue(UnicodeTranslator.toAscii("abc123union").equals("abc123union"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_INTEGER").equals("abc_INTEGER"));
		assertTrue(UnicodeTranslator.toAscii("abc_integer").equals("abc_integer"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_NATURAL").equals("abc_NATURAL"));
		assertTrue(UnicodeTranslator.toAscii("abc_natural").equals("abc_natural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcFALSE123").equals("abcFALSE123"));
		assertTrue(UnicodeTranslator.toAscii("abcfalse123").equals("abcfalse123"));
	}
	@Test
	public void LetterINTEGERDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abcINTEGER123").equals("abcINTEGER123"));
		assertTrue(UnicodeTranslator.toAscii("abcinteger123").equals("abcinteger123"));
	}
	@Test
	public void LetterINTERDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abcINTER123").equals("abcINTER123"));
		assertTrue(UnicodeTranslator.toAscii("abcinter123").equals("abcinter123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcNATURAL123").equals("abcNATURAL123"));
		assertTrue(UnicodeTranslator.toAscii("abcnatural123").equals("abcnatural123"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcUNION123").equals("abcUNION123"));
		assertTrue(UnicodeTranslator.toAscii("abcunion123").equals("abcunion123"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcINTEGER_").equals("abcINTEGER_"));
		assertTrue(UnicodeTranslator.toAscii("abcinteger_").equals("abcinteger_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcNATURAL_").equals("abcNATURAL_"));
		assertTrue(UnicodeTranslator.toAscii("abcnatural_").equals("abcnatural_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc123_FALSE").equals("abc123_FALSE"));
		assertTrue(UnicodeTranslator.toAscii("abc123_false").equals("abc123_false"));
	}
	@Test
	public void LetterDigitUnderscoreINTEGER()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123_INTEGER").equals("abc123_INTEGER"));
		assertTrue(UnicodeTranslator.toAscii("abc123_integer").equals("abc123_integer"));
	}
	@Test
	public void LetterDigitUnderscoreINTER()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123_INTER").equals("abc123_INTER"));
		assertTrue(UnicodeTranslator.toAscii("abc123_inter").equals("abc123_inter"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc123_NAT1").equals("abc123_NAT1"));
		assertTrue(UnicodeTranslator.toAscii("abc123_nat1").equals("abc123_nat1"));
	}
	@Test
	public void LetterDigitUnderscoreNATURAL()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123_NATURAL").equals("abc123_NATURAL"));
		assertTrue(UnicodeTranslator.toAscii("abc123_natural").equals("abc123_natural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc123_POW1").equals("abc123_POW1"));
		assertTrue(UnicodeTranslator.toAscii("abc123_pow1").equals("abc123_pow1"));
	}
	@Test
	public void LetterDigitUnderscoreTRUE()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123_TRUE").equals("abc123_TRUE"));
		assertTrue(UnicodeTranslator.toAscii("abc123_true").equals("abc123_true"));
	}
	@Test
	public void LetterDigitUnderscoreUNION()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123_UNION").equals("abc123_UNION"));
		assertTrue(UnicodeTranslator.toAscii("abc123_union").equals("abc123_union"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc123FALSE_").equals("abc123FALSE_"));
		assertTrue(UnicodeTranslator.toAscii("abc123false_").equals("abc123false_"));
	}
	@Test
	public void LetterDigitINTEGERUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123INTEGER_").equals("abc123INTEGER_"));
		assertTrue(UnicodeTranslator.toAscii("abc123integer_").equals("abc123integer_"));
	}
	@Test
	public void LetterDigitINTERUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123INTER_").equals("abc123INTER_"));
		assertTrue(UnicodeTranslator.toAscii("abc123inter_").equals("abc123inter_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc123NAT1_").equals("abc123NAT1_"));
		assertTrue(UnicodeTranslator.toAscii("abc123nat1_").equals("abc123nat1_"));
	}
	@Test
	public void LetterDigitNATURALUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123NATURAL_").equals("abc123NATURAL_"));
		assertTrue(UnicodeTranslator.toAscii("abc123natural_").equals("abc123natural_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc123POW1_").equals("abc123POW1_"));
		assertTrue(UnicodeTranslator.toAscii("abc123pow1_").equals("abc123pow1_"));
	}
	@Test
	public void LetterDigitTRUEUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123TRUE_").equals("abc123TRUE_"));
		assertTrue(UnicodeTranslator.toAscii("abc123true_").equals("abc123true_"));
	}
	@Test
	public void LetterDigitUNIONUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("abc123UNION_").equals("abc123UNION_"));
		assertTrue(UnicodeTranslator.toAscii("abc123union_").equals("abc123union_"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_123FALSE").equals("abc_123FALSE"));
		assertTrue(UnicodeTranslator.toAscii("abc_123false").equals("abc_123false"));
	}
	@Test
	public void LetterUnderscoreDigitINTEGER()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_123INTEGER").equals("abc_123INTEGER"));
		assertTrue(UnicodeTranslator.toAscii("abc_123integer").equals("abc_123integer"));
	}
	@Test
	public void LetterUnderscoreDigitINTER()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_123INTER").equals("abc_123INTER"));
		assertTrue(UnicodeTranslator.toAscii("abc_123inter").equals("abc_123inter"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_123NAT1").equals("abc_123NAT1"));
		assertTrue(UnicodeTranslator.toAscii("abc_123nat1").equals("abc_123nat1"));
	}
	@Test
	public void LetterUnderscoreDigitNATURAL()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_123NATURAL").equals("abc_123NATURAL"));
		assertTrue(UnicodeTranslator.toAscii("abc_123natural").equals("abc_123natural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_123POW1").equals("abc_123POW1"));
		assertTrue(UnicodeTranslator.toAscii("abc_123pow1").equals("abc_123pow1"));
	}
	@Test
	public void LetterUnderscoreDigitTRUE()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_123TRUE").equals("abc_123TRUE"));
		assertTrue(UnicodeTranslator.toAscii("abc_123true").equals("abc_123true"));
	}
	@Test
	public void LetterUnderscoreDigitUNION()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_123UNION").equals("abc_123UNION"));
		assertTrue(UnicodeTranslator.toAscii("abc_123union").equals("abc_123union"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_FALSE123").equals("abc_FALSE123"));
		assertTrue(UnicodeTranslator.toAscii("abc_false123").equals("abc_false123"));
	}
	@Test
	public void LetterUnderscoreINTEGERDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_INTEGER123").equals("abc_INTEGER123"));
		assertTrue(UnicodeTranslator.toAscii("abc_integer123").equals("abc_integer123"));
	}
	@Test
	public void LetterUnderscoreINTERDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_INTER123").equals("abc_INTER123"));
		assertTrue(UnicodeTranslator.toAscii("abc_inter123").equals("abc_inter123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_NAT1123").equals("abc_NAT1123"));
		assertTrue(UnicodeTranslator.toAscii("abc_nat1123").equals("abc_nat1123"));
	}
	@Test
	public void LetterUnderscoreNATURALDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_NATURAL123").equals("abc_NATURAL123"));
		assertTrue(UnicodeTranslator.toAscii("abc_natural123").equals("abc_natural123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_POW1123").equals("abc_POW1123"));
		assertTrue(UnicodeTranslator.toAscii("abc_pow1123").equals("abc_pow1123"));
	}
	@Test
	public void LetterUnderscoreTRUEDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_TRUE123").equals("abc_TRUE123"));
		assertTrue(UnicodeTranslator.toAscii("abc_true123").equals("abc_true123"));
	}
	@Test
	public void LetterUnderscoreUNIONDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_UNION123").equals("abc_UNION123"));
		assertTrue(UnicodeTranslator.toAscii("abc_union123").equals("abc_union123"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcFALSE123_").equals("abcFALSE123_"));
		assertTrue(UnicodeTranslator.toAscii("abcfalse123_").equals("abcfalse123_"));
	}
	@Test
	public void LetterINTEGERDigitUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("abcINTEGER123_").equals("abcINTEGER123_"));
		assertTrue(UnicodeTranslator.toAscii("abcinteger123_").equals("abcinteger123_"));
	}
	@Test
	public void LetterINTERDigitUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("abcINTER123_").equals("abcINTER123_"));
		assertTrue(UnicodeTranslator.toAscii("abcinter123_").equals("abcinter123_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcNAT1123_").equals("abcNAT1123_"));
		assertTrue(UnicodeTranslator.toAscii("abcnat1123_").equals("abcnat1123_"));
	}
	@Test
	public void LetterNATURALDigitUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("abcNATURAL123_").equals("abcNATURAL123_"));
		assertTrue(UnicodeTranslator.toAscii("abcnatural123_").equals("abcnatural123_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcPOW1123_").equals("abcPOW1123_"));
		assertTrue(UnicodeTranslator.toAscii("abcpow1123_").equals("abcpow1123_"));
	}
	@Test
	public void LetterTRUEDigitUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("abcTRUE123_").equals("abcTRUE123_"));
		assertTrue(UnicodeTranslator.toAscii("abctrue123_").equals("abctrue123_"));
	}
	@Test
	public void LetterUNIONDigitUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("abcUNION123_").equals("abcUNION123_"));
		assertTrue(UnicodeTranslator.toAscii("abcunion123_").equals("abcunion123_"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcFALSE_123").equals("abcFALSE_123"));
		assertTrue(UnicodeTranslator.toAscii("abcfalse_123").equals("abcfalse_123"));
	}
	@Test
	public void LetterINTEGERUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abcINTEGER_123").equals("abcINTEGER_123"));
		assertTrue(UnicodeTranslator.toAscii("abcinteger_123").equals("abcinteger_123"));
	}
	@Test
	public void LetterINTERUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abcINTER_123").equals("abcINTER_123"));
		assertTrue(UnicodeTranslator.toAscii("abcinter_123").equals("abcinter_123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcNAT1_123").equals("abcNAT1_123"));
		assertTrue(UnicodeTranslator.toAscii("abcnat1_123").equals("abcnat1_123"));
	}
	@Test
	public void LetterNATURALUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abcNATURAL_123").equals("abcNATURAL_123"));
		assertTrue(UnicodeTranslator.toAscii("abcnatural_123").equals("abcnatural_123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abcPOW1_123").equals("abcPOW1_123"));
		assertTrue(UnicodeTranslator.toAscii("abcpow1_123").equals("abcpow1_123"));
	}
	@Test
	public void LetterTRUEUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abcTRUE_123").equals("abcTRUE_123"));
		assertTrue(UnicodeTranslator.toAscii("abctrue_123").equals("abctrue_123"));
	}
	@Test
	public void LetterUNIONUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("abcUNION_123").equals("abcUNION_123"));
		assertTrue(UnicodeTranslator.toAscii("abcunion_123").equals("abcunion_123"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123abcFALSE").equals("123abcFALSE"));
		assertTrue(UnicodeTranslator.toAscii("123abcfalse").equals("123abcfalse"));
	}
	@Test
	public void DigitLetterINTEGER()
	{
		assertTrue(UnicodeTranslator.toAscii("123abcINTEGER").equals("123abcINTEGER"));
		assertTrue(UnicodeTranslator.toAscii("123abcinteger").equals("123abcinteger"));
	}
	@Test
	public void DigitLetterINTER()
	{
		assertTrue(UnicodeTranslator.toAscii("123abcINTER").equals("123abcINTER"));
		assertTrue(UnicodeTranslator.toAscii("123abcinter").equals("123abcinter"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123abcNATURAL").equals("123abcNATURAL"));
		assertTrue(UnicodeTranslator.toAscii("123abcnatural").equals("123abcnatural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123abcUNION").equals("123abcUNION"));
		assertTrue(UnicodeTranslator.toAscii("123abcunion").equals("123abcunion"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_INTEGER").equals("123_INTEGER"));
		assertTrue(UnicodeTranslator.toAscii("123_integer").equals("123_integer"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_NATURAL").equals("123_NATURAL"));
		assertTrue(UnicodeTranslator.toAscii("123_natural").equals("123_natural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123FALSEabc").equals("123FALSEabc"));
		assertTrue(UnicodeTranslator.toAscii("123falseabc").equals("123falseabc"));
	}
	@Test
	public void DigitINTEGERLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123INTEGERabc").equals("123INTEGERabc"));
		assertTrue(UnicodeTranslator.toAscii("123integerabc").equals("123integerabc"));
	}
	@Test
	public void DigitINTERLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123INTERabc").equals("123INTERabc"));
		assertTrue(UnicodeTranslator.toAscii("123interabc").equals("123interabc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123NATURALabc").equals("123NATURALabc"));
		assertTrue(UnicodeTranslator.toAscii("123naturalabc").equals("123naturalabc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123UNIONabc").equals("123UNIONabc"));
		assertTrue(UnicodeTranslator.toAscii("123unionabc").equals("123unionabc"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123INTEGER_").equals("123INTEGER_"));
		assertTrue(UnicodeTranslator.toAscii("123integer_").equals("123integer_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123NATURAL_").equals("123NATURAL_"));
		assertTrue(UnicodeTranslator.toAscii("123natural_").equals("123natural_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123abc_FALSE").equals("123abc_FALSE"));
		assertTrue(UnicodeTranslator.toAscii("123abc_false").equals("123abc_false"));
	}
	@Test
	public void DigitLetterUnderscoreINTEGER()
	{
		assertTrue(UnicodeTranslator.toAscii("123abc_INTEGER").equals("123abc_INTEGER"));
		assertTrue(UnicodeTranslator.toAscii("123abc_integer").equals("123abc_integer"));
	}
	@Test
	public void DigitLetterUnderscoreINTER()
	{
		assertTrue(UnicodeTranslator.toAscii("123abc_INTER").equals("123abc_INTER"));
		assertTrue(UnicodeTranslator.toAscii("123abc_inter").equals("123abc_inter"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123abc_NAT1").equals("123abc_NAT1"));
		assertTrue(UnicodeTranslator.toAscii("123abc_nat1").equals("123abc_nat1"));
	}
	@Test
	public void DigitLetterUnderscoreNATURAL()
	{
		assertTrue(UnicodeTranslator.toAscii("123abc_NATURAL").equals("123abc_NATURAL"));
		assertTrue(UnicodeTranslator.toAscii("123abc_natural").equals("123abc_natural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123abc_POW1").equals("123abc_POW1"));
		assertTrue(UnicodeTranslator.toAscii("123abc_pow1").equals("123abc_pow1"));
	}
	@Test
	public void DigitLetterUnderscoreTRUE()
	{
		assertTrue(UnicodeTranslator.toAscii("123abc_TRUE").equals("123abc_TRUE"));
		assertTrue(UnicodeTranslator.toAscii("123abc_true").equals("123abc_true"));
	}
	@Test
	public void DigitLetterUnderscoreUNION()
	{
		assertTrue(UnicodeTranslator.toAscii("123abc_UNION").equals("123abc_UNION"));
		assertTrue(UnicodeTranslator.toAscii("123abc_union").equals("123abc_union"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123abcFALSE_").equals("123abcFALSE_"));
		assertTrue(UnicodeTranslator.toAscii("123abcfalse_").equals("123abcfalse_"));
	}
	@Test
	public void DigitLetterINTEGERUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("123abcINTEGER_").equals("123abcINTEGER_"));
		assertTrue(UnicodeTranslator.toAscii("123abcinteger_").equals("123abcinteger_"));
	}
	@Test
	public void DigitLetterINTERUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("123abcINTER_").equals("123abcINTER_"));
		assertTrue(UnicodeTranslator.toAscii("123abcinter_").equals("123abcinter_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123abcNAT1_").equals("123abcNAT1_"));
		assertTrue(UnicodeTranslator.toAscii("123abcnat1_").equals("123abcnat1_"));
	}
	@Test
	public void DigitLetterNATURALUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("123abcNATURAL_").equals("123abcNATURAL_"));
		assertTrue(UnicodeTranslator.toAscii("123abcnatural_").equals("123abcnatural_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123abcPOW1_").equals("123abcPOW1_"));
		assertTrue(UnicodeTranslator.toAscii("123abcpow1_").equals("123abcpow1_"));
	}
	@Test
	public void DigitLetterTRUEUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("123abcTRUE_").equals("123abcTRUE_"));
		assertTrue(UnicodeTranslator.toAscii("123abctrue_").equals("123abctrue_"));
	}
	@Test
	public void DigitLetterUNIONUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("123abcUNION_").equals("123abcUNION_"));
		assertTrue(UnicodeTranslator.toAscii("123abcunion_").equals("123abcunion_"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_abcFALSE").equals("123_abcFALSE"));
		assertTrue(UnicodeTranslator.toAscii("123_abcfalse").equals("123_abcfalse"));
	}
	@Test
	public void DigitUnderscoreLetterINTEGER()
	{
		assertTrue(UnicodeTranslator.toAscii("123_abcINTEGER").equals("123_abcINTEGER"));
		assertTrue(UnicodeTranslator.toAscii("123_abcinteger").equals("123_abcinteger"));
	}
	@Test
	public void DigitUnderscoreLetterINTER()
	{
		assertTrue(UnicodeTranslator.toAscii("123_abcINTER").equals("123_abcINTER"));
		assertTrue(UnicodeTranslator.toAscii("123_abcinter").equals("123_abcinter"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_abcNAT1").equals("123_abcNAT1"));
		assertTrue(UnicodeTranslator.toAscii("123_abcnat1").equals("123_abcnat1"));
	}
	@Test
	public void DigitUnderscoreLetterNATURAL()
	{
		assertTrue(UnicodeTranslator.toAscii("123_abcNATURAL").equals("123_abcNATURAL"));
		assertTrue(UnicodeTranslator.toAscii("123_abcnatural").equals("123_abcnatural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_abcPOW1").equals("123_abcPOW1"));
		assertTrue(UnicodeTranslator.toAscii("123_abcpow1").equals("123_abcpow1"));
	}
	@Test
	public void DigitUnderscoreLetterTRUE()
	{
		assertTrue(UnicodeTranslator.toAscii("123_abcTRUE").equals("123_abcTRUE"));
		assertTrue(UnicodeTranslator.toAscii("123_abctrue").equals("123_abctrue"));
	}
	@Test
	public void DigitUnderscoreLetterUNION()
	{
		assertTrue(UnicodeTranslator.toAscii("123_abcUNION").equals("123_abcUNION"));
		assertTrue(UnicodeTranslator.toAscii("123_abcunion").equals("123_abcunion"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_FALSEabc").equals("123_FALSEabc"));
		assertTrue(UnicodeTranslator.toAscii("123_falseabc").equals("123_falseabc"));
	}
	@Test
	public void DigitUnderscoreINTEGERLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123_INTEGERabc").equals("123_INTEGERabc"));
		assertTrue(UnicodeTranslator.toAscii("123_integerabc").equals("123_integerabc"));
	}
	@Test
	public void DigitUnderscoreINTERLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123_INTERabc").equals("123_INTERabc"));
		assertTrue(UnicodeTranslator.toAscii("123_interabc").equals("123_interabc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_NAT1abc").equals("123_NAT1abc"));
		assertTrue(UnicodeTranslator.toAscii("123_nat1abc").equals("123_nat1abc"));
	}
	@Test
	public void DigitUnderscoreNATURALLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123_NATURALabc").equals("123_NATURALabc"));
		assertTrue(UnicodeTranslator.toAscii("123_naturalabc").equals("123_naturalabc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_POW1abc").equals("123_POW1abc"));
		assertTrue(UnicodeTranslator.toAscii("123_pow1abc").equals("123_pow1abc"));
	}
	@Test
	public void DigitUnderscoreTRUELetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123_TRUEabc").equals("123_TRUEabc"));
		assertTrue(UnicodeTranslator.toAscii("123_trueabc").equals("123_trueabc"));
	}
	@Test
	public void DigitUnderscoreUNIONLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123_UNIONabc").equals("123_UNIONabc"));
		assertTrue(UnicodeTranslator.toAscii("123_unionabc").equals("123_unionabc"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123FALSEabc_").equals("123FALSEabc_"));
		assertTrue(UnicodeTranslator.toAscii("123falseabc_").equals("123falseabc_"));
	}
	@Test
	public void DigitINTEGERLetterUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("123INTEGERabc_").equals("123INTEGERabc_"));
		assertTrue(UnicodeTranslator.toAscii("123integerabc_").equals("123integerabc_"));
	}
	@Test
	public void DigitINTERLetterUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("123INTERabc_").equals("123INTERabc_"));
		assertTrue(UnicodeTranslator.toAscii("123interabc_").equals("123interabc_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123NAT1abc_").equals("123NAT1abc_"));
		assertTrue(UnicodeTranslator.toAscii("123nat1abc_").equals("123nat1abc_"));
	}
	@Test
	public void DigitNATURALLetterUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("123NATURALabc_").equals("123NATURALabc_"));
		assertTrue(UnicodeTranslator.toAscii("123naturalabc_").equals("123naturalabc_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123POW1abc_").equals("123POW1abc_"));
		assertTrue(UnicodeTranslator.toAscii("123pow1abc_").equals("123pow1abc_"));
	}
	@Test
	public void DigitTRUELetterUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("123TRUEabc_").equals("123TRUEabc_"));
		assertTrue(UnicodeTranslator.toAscii("123trueabc_").equals("123trueabc_"));
	}
	@Test
	public void DigitUNIONLetterUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("123UNIONabc_").equals("123UNIONabc_"));
		assertTrue(UnicodeTranslator.toAscii("123unionabc_").equals("123unionabc_"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123FALSE_abc").equals("123FALSE_abc"));
		assertTrue(UnicodeTranslator.toAscii("123false_abc").equals("123false_abc"));
	}
	@Test
	public void DigitINTEGERUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123INTEGER_abc").equals("123INTEGER_abc"));
		assertTrue(UnicodeTranslator.toAscii("123integer_abc").equals("123integer_abc"));
	}
	@Test
	public void DigitINTERUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123INTER_abc").equals("123INTER_abc"));
		assertTrue(UnicodeTranslator.toAscii("123inter_abc").equals("123inter_abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123NAT1_abc").equals("123NAT1_abc"));
		assertTrue(UnicodeTranslator.toAscii("123nat1_abc").equals("123nat1_abc"));
	}
	@Test
	public void DigitNATURALUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123NATURAL_abc").equals("123NATURAL_abc"));
		assertTrue(UnicodeTranslator.toAscii("123natural_abc").equals("123natural_abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123POW1_abc").equals("123POW1_abc"));
		assertTrue(UnicodeTranslator.toAscii("123pow1_abc").equals("123pow1_abc"));
	}
	@Test
	public void DigitTRUEUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123TRUE_abc").equals("123TRUE_abc"));
		assertTrue(UnicodeTranslator.toAscii("123true_abc").equals("123true_abc"));
	}
	@Test
	public void DigitUNIONUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("123UNION_abc").equals("123UNION_abc"));
		assertTrue(UnicodeTranslator.toAscii("123union_abc").equals("123union_abc"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_123INTEGER").equals("_123INTEGER"));
		assertTrue(UnicodeTranslator.toAscii("_123integer").equals("_123integer"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_123NATURAL").equals("_123NATURAL"));
		assertTrue(UnicodeTranslator.toAscii("_123natural").equals("_123natural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_INTEGERabc").equals("_INTEGERabc"));
		assertTrue(UnicodeTranslator.toAscii("_integerabc").equals("_integerabc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_NATURALabc").equals("_NATURALabc"));
		assertTrue(UnicodeTranslator.toAscii("_naturalabc").equals("_naturalabc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_INTEGER123").equals("_INTEGER123"));
		assertTrue(UnicodeTranslator.toAscii("_integer123").equals("_integer123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_NATURAL123").equals("_NATURAL123"));
		assertTrue(UnicodeTranslator.toAscii("_natural123").equals("_natural123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_abc123FALSE").equals("_abc123FALSE"));
		assertTrue(UnicodeTranslator.toAscii("_abc123false").equals("_abc123false"));
	}
	@Test
	public void UnderscoreLetterDigitINTEGER()
	{
		assertTrue(UnicodeTranslator.toAscii("_abc123INTEGER").equals("_abc123INTEGER"));
		assertTrue(UnicodeTranslator.toAscii("_abc123integer").equals("_abc123integer"));
	}
	@Test
	public void UnderscoreLetterDigitINTER()
	{
		assertTrue(UnicodeTranslator.toAscii("_abc123INTER").equals("_abc123INTER"));
		assertTrue(UnicodeTranslator.toAscii("_abc123inter").equals("_abc123inter"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_abc123NAT1").equals("_abc123NAT1"));
		assertTrue(UnicodeTranslator.toAscii("_abc123nat1").equals("_abc123nat1"));
	}
	@Test
	public void UnderscoreLetterDigitNATURAL()
	{
		assertTrue(UnicodeTranslator.toAscii("_abc123NATURAL").equals("_abc123NATURAL"));
		assertTrue(UnicodeTranslator.toAscii("_abc123natural").equals("_abc123natural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_abc123POW1").equals("_abc123POW1"));
		assertTrue(UnicodeTranslator.toAscii("_abc123pow1").equals("_abc123pow1"));
	}
	@Test
	public void UnderscoreLetterDigitTRUE()
	{
		assertTrue(UnicodeTranslator.toAscii("_abc123TRUE").equals("_abc123TRUE"));
		assertTrue(UnicodeTranslator.toAscii("_abc123true").equals("_abc123true"));
	}
	@Test
	public void UnderscoreLetterDigitUNION()
	{
		assertTrue(UnicodeTranslator.toAscii("_abc123UNION").equals("_abc123UNION"));
		assertTrue(UnicodeTranslator.toAscii("_abc123union").equals("_abc123union"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_abcFALSE123").equals("_abcFALSE123"));
		assertTrue(UnicodeTranslator.toAscii("_abcfalse123").equals("_abcfalse123"));
	}
	@Test
	public void UnderscoreLetterINTEGERDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("_abcINTEGER123").equals("_abcINTEGER123"));
		assertTrue(UnicodeTranslator.toAscii("_abcinteger123").equals("_abcinteger123"));
	}
	@Test
	public void UnderscoreLetterINTERDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("_abcINTER123").equals("_abcINTER123"));
		assertTrue(UnicodeTranslator.toAscii("_abcinter123").equals("_abcinter123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_abcNAT1123").equals("_abcNAT1123"));
		assertTrue(UnicodeTranslator.toAscii("_abcnat1123").equals("_abcnat1123"));
	}
	@Test
	public void UnderscoreLetterNATURALDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("_abcNATURAL123").equals("_abcNATURAL123"));
		assertTrue(UnicodeTranslator.toAscii("_abcnatural123").equals("_abcnatural123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_abcPOW1123").equals("_abcPOW1123"));
		assertTrue(UnicodeTranslator.toAscii("_abcpow1123").equals("_abcpow1123"));
	}
	@Test
	public void UnderscoreLetterTRUEDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("_abcTRUE123").equals("_abcTRUE123"));
		assertTrue(UnicodeTranslator.toAscii("_abctrue123").equals("_abctrue123"));
	}
	@Test
	public void UnderscoreLetterUNIONDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("_abcUNION123").equals("_abcUNION123"));
		assertTrue(UnicodeTranslator.toAscii("_abcunion123").equals("_abcunion123"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_123abcFALSE").equals("_123abcFALSE"));
		assertTrue(UnicodeTranslator.toAscii("_123abcfalse").equals("_123abcfalse"));
	}
	@Test
	public void UnderscoreDigitLetterINTEGER()
	{
		assertTrue(UnicodeTranslator.toAscii("_123abcINTEGER").equals("_123abcINTEGER"));
		assertTrue(UnicodeTranslator.toAscii("_123abcinteger").equals("_123abcinteger"));
	}
	@Test
	public void UnderscoreDigitLetterINTER()
	{
		assertTrue(UnicodeTranslator.toAscii("_123abcINTER").equals("_123abcINTER"));
		assertTrue(UnicodeTranslator.toAscii("_123abcinter").equals("_123abcinter"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_123abcNAT1").equals("_123abcNAT1"));
		assertTrue(UnicodeTranslator.toAscii("_123abcnat1").equals("_123abcnat1"));
	}
	@Test
	public void UnderscoreDigitLetterNATURAL()
	{
		assertTrue(UnicodeTranslator.toAscii("_123abcNATURAL").equals("_123abcNATURAL"));
		assertTrue(UnicodeTranslator.toAscii("_123abcnatural").equals("_123abcnatural"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_123abcPOW1").equals("_123abcPOW1"));
		assertTrue(UnicodeTranslator.toAscii("_123abcpow1").equals("_123abcpow1"));
	}
	@Test
	public void UnderscoreDigitLetterTRUE()
	{
		assertTrue(UnicodeTranslator.toAscii("_123abcTRUE").equals("_123abcTRUE"));
		assertTrue(UnicodeTranslator.toAscii("_123abctrue").equals("_123abctrue"));
	}
	@Test
	public void UnderscoreDigitLetterUNION()
	{
		assertTrue(UnicodeTranslator.toAscii("_123abcUNION").equals("_123abcUNION"));
		assertTrue(UnicodeTranslator.toAscii("_123abcunion").equals("_123abcunion"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_123FALSEabc").equals("_123FALSEabc"));
		assertTrue(UnicodeTranslator.toAscii("_123falseabc").equals("_123falseabc"));
	}
	@Test
	public void UnderscoreDigitINTEGERLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("_123INTEGERabc").equals("_123INTEGERabc"));
		assertTrue(UnicodeTranslator.toAscii("_123integerabc").equals("_123integerabc"));
	}
	@Test
	public void UnderscoreDigitINTERLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("_123INTERabc").equals("_123INTERabc"));
		assertTrue(UnicodeTranslator.toAscii("_123interabc").equals("_123interabc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_123NAT1abc").equals("_123NAT1abc"));
		assertTrue(UnicodeTranslator.toAscii("_123nat1abc").equals("_123nat1abc"));
	}
	@Test
	public void UnderscoreDigitNATURALLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("_123NATURALabc").equals("_123NATURALabc"));
		assertTrue(UnicodeTranslator.toAscii("_123naturalabc").equals("_123naturalabc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_123POW1abc").equals("_123POW1abc"));
		assertTrue(UnicodeTranslator.toAscii("_123pow1abc").equals("_123pow1abc"));
	}
	@Test
	public void UnderscoreDigitTRUELetter()
	{
		assertTrue(UnicodeTranslator.toAscii("_123TRUEabc").equals("_123TRUEabc"));
		assertTrue(UnicodeTranslator.toAscii("_123trueabc").equals("_123trueabc"));
	}
	@Test
	public void UnderscoreDigitUNIONLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("_123UNIONabc").equals("_123UNIONabc"));
		assertTrue(UnicodeTranslator.toAscii("_123unionabc").equals("_123unionabc"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_FALSEabc123").equals("_FALSEabc123"));
		assertTrue(UnicodeTranslator.toAscii("_falseabc123").equals("_falseabc123"));
	}
	@Test
	public void UnderscoreINTEGERLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("_INTEGERabc123").equals("_INTEGERabc123"));
		assertTrue(UnicodeTranslator.toAscii("_integerabc123").equals("_integerabc123"));
	}
	@Test
	public void UnderscoreINTERLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("_INTERabc123").equals("_INTERabc123"));
		assertTrue(UnicodeTranslator.toAscii("_interabc123").equals("_interabc123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_NAT1abc123").equals("_NAT1abc123"));
		assertTrue(UnicodeTranslator.toAscii("_nat1abc123").equals("_nat1abc123"));
	}
	@Test
	public void UnderscoreNATURALLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("_NATURALabc123").equals("_NATURALabc123"));
		assertTrue(UnicodeTranslator.toAscii("_naturalabc123").equals("_naturalabc123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_POW1abc123").equals("_POW1abc123"));
		assertTrue(UnicodeTranslator.toAscii("_pow1abc123").equals("_pow1abc123"));
	}
	@Test
	public void UnderscoreTRUELetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("_TRUEabc123").equals("_TRUEabc123"));
		assertTrue(UnicodeTranslator.toAscii("_trueabc123").equals("_trueabc123"));
	}
	@Test
	public void UnderscoreUNIONLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("_UNIONabc123").equals("_UNIONabc123"));
		assertTrue(UnicodeTranslator.toAscii("_unionabc123").equals("_unionabc123"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_FALSE123abc").equals("_FALSE123abc"));
		assertTrue(UnicodeTranslator.toAscii("_false123abc").equals("_false123abc"));
	}
	@Test
	public void UnderscoreINTEGERDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("_INTEGER123abc").equals("_INTEGER123abc"));
		assertTrue(UnicodeTranslator.toAscii("_integer123abc").equals("_integer123abc"));
	}
	@Test
	public void UnderscoreINTERDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("_INTER123abc").equals("_INTER123abc"));
		assertTrue(UnicodeTranslator.toAscii("_inter123abc").equals("_inter123abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_NAT1123abc").equals("_NAT1123abc"));
		assertTrue(UnicodeTranslator.toAscii("_nat1123abc").equals("_nat1123abc"));
	}
	@Test
	public void UnderscoreNATURALDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("_NATURAL123abc").equals("_NATURAL123abc"));
		assertTrue(UnicodeTranslator.toAscii("_natural123abc").equals("_natural123abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("_POW1123abc").equals("_POW1123abc"));
		assertTrue(UnicodeTranslator.toAscii("_pow1123abc").equals("_pow1123abc"));
	}
	@Test
	public void UnderscoreTRUEDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("_TRUE123abc").equals("_TRUE123abc"));
		assertTrue(UnicodeTranslator.toAscii("_true123abc").equals("_true123abc"));
	}
	@Test
	public void UnderscoreUNIONDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("_UNION123abc").equals("_UNION123abc"));
		assertTrue(UnicodeTranslator.toAscii("_union123abc").equals("_union123abc"));
	}
...
//	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("FALSEabc123").equals("FALSEabc123"));
		assertTrue(UnicodeTranslator.toAscii("falseabc123").equals("falseabc123"));
	}
	@Test
	public void INTEGERLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGERabc123").equals("INTEGERabc123"));
		assertTrue(UnicodeTranslator.toAscii("integerabc123").equals("integerabc123"));
	}
	@Test
	public void INTERLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("INTERabc123").equals("INTERabc123"));
		assertTrue(UnicodeTranslator.toAscii("interabc123").equals("interabc123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NATURALabc123").equals("NATURALabc123"));
		assertTrue(UnicodeTranslator.toAscii("naturalabc123").equals("naturalabc123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("UNIONabc123").equals("UNIONabc123"));
		assertTrue(UnicodeTranslator.toAscii("unionabc123").equals("unionabc123"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGERabc_").equals("INTEGERabc_"));
		assertTrue(UnicodeTranslator.toAscii("integerabc_").equals("integerabc_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NATURALabc_").equals("NATURALabc_"));
		assertTrue(UnicodeTranslator.toAscii("naturalabc_").equals("naturalabc_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("FALSE123abc").equals("FALSE123abc"));
		assertTrue(UnicodeTranslator.toAscii("false123abc").equals("false123abc"));
	}
	@Test
	public void INTEGERDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGER123abc").equals("INTEGER123abc"));
		assertTrue(UnicodeTranslator.toAscii("integer123abc").equals("integer123abc"));
	}
	@Test
	public void INTERDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("INTER123abc").equals("INTER123abc"));
		assertTrue(UnicodeTranslator.toAscii("inter123abc").equals("inter123abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NATURAL123abc").equals("NATURAL123abc"));
		assertTrue(UnicodeTranslator.toAscii("natural123abc").equals("natural123abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("UNION123abc").equals("UNION123abc"));
		assertTrue(UnicodeTranslator.toAscii("union123abc").equals("union123abc"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGER123_").equals("INTEGER123_"));
		assertTrue(UnicodeTranslator.toAscii("integer123_").equals("integer123_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NATURAL123_").equals("NATURAL123_"));
		assertTrue(UnicodeTranslator.toAscii("natural123_").equals("natural123_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGER_abc").equals("INTEGER_abc"));
		assertTrue(UnicodeTranslator.toAscii("integer_abc").equals("integer_abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NATURAL_abc").equals("NATURAL_abc"));
		assertTrue(UnicodeTranslator.toAscii("natural_abc").equals("natural_abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGER_123").equals("INTEGER_123"));
		assertTrue(UnicodeTranslator.toAscii("integer_123").equals("integer_123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NATURAL_123").equals("NATURAL_123"));
		assertTrue(UnicodeTranslator.toAscii("natural_123").equals("natural_123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("FALSEabc123_").equals("FALSEabc123_"));
		assertTrue(UnicodeTranslator.toAscii("falseabc123_").equals("falseabc123_"));
	}
	@Test
	public void INTEGERLetterDigitUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGERabc123_").equals("INTEGERabc123_"));
		assertTrue(UnicodeTranslator.toAscii("integerabc123_").equals("integerabc123_"));
	}
	@Test
	public void INTERLetterDigitUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("INTERabc123_").equals("INTERabc123_"));
		assertTrue(UnicodeTranslator.toAscii("interabc123_").equals("interabc123_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NAT1abc123_").equals("NAT1abc123_"));
		assertTrue(UnicodeTranslator.toAscii("nat1abc123_").equals("nat1abc123_"));
	}
	@Test
	public void NATURALLetterDigitUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("NATURALabc123_").equals("NATURALabc123_"));
		assertTrue(UnicodeTranslator.toAscii("naturalabc123_").equals("naturalabc123_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("POW1abc123_").equals("POW1abc123_"));
		assertTrue(UnicodeTranslator.toAscii("pow1abc123_").equals("pow1abc123_"));
	}
	@Test
	public void TRUELetterDigitUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("TRUEabc123_").equals("TRUEabc123_"));
		assertTrue(UnicodeTranslator.toAscii("trueabc123_").equals("trueabc123_"));
	}
	@Test
	public void UNIONLetterDigitUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("UNIONabc123_").equals("UNIONabc123_"));
		assertTrue(UnicodeTranslator.toAscii("unionabc123_").equals("unionabc123_"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("FALSEabc_123").equals("FALSEabc_123"));
		assertTrue(UnicodeTranslator.toAscii("falseabc_123").equals("falseabc_123"));
	}
	@Test
	public void INTEGERLetterUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGERabc_123").equals("INTEGERabc_123"));
		assertTrue(UnicodeTranslator.toAscii("integerabc_123").equals("integerabc_123"));
	}
	@Test
	public void INTERLetterUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("INTERabc_123").equals("INTERabc_123"));
		assertTrue(UnicodeTranslator.toAscii("interabc_123").equals("interabc_123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NAT1abc_123").equals("NAT1abc_123"));
		assertTrue(UnicodeTranslator.toAscii("nat1abc_123").equals("nat1abc_123"));
	}
	@Test
	public void NATURALLetterUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("NATURALabc_123").equals("NATURALabc_123"));
		assertTrue(UnicodeTranslator.toAscii("naturalabc_123").equals("naturalabc_123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("POW1abc_123").equals("POW1abc_123"));
		assertTrue(UnicodeTranslator.toAscii("pow1abc_123").equals("pow1abc_123"));
	}
	@Test
	public void TRUELetterUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("TRUEabc_123").equals("TRUEabc_123"));
		assertTrue(UnicodeTranslator.toAscii("trueabc_123").equals("trueabc_123"));
	}
	@Test
	public void UNIONLetterUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("UNIONabc_123").equals("UNIONabc_123"));
		assertTrue(UnicodeTranslator.toAscii("unionabc_123").equals("unionabc_123"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("FALSE123abc_").equals("FALSE123abc_"));
		assertTrue(UnicodeTranslator.toAscii("false123abc_").equals("false123abc_"));
	}
	@Test
	public void INTEGERDigitLetterUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGER123abc_").equals("INTEGER123abc_"));
		assertTrue(UnicodeTranslator.toAscii("integer123abc_").equals("integer123abc_"));
	}
	@Test
	public void INTERDigitLetterUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("INTER123abc_").equals("INTER123abc_"));
		assertTrue(UnicodeTranslator.toAscii("inter123abc_").equals("inter123abc_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NAT1123abc_").equals("NAT1123abc_"));
		assertTrue(UnicodeTranslator.toAscii("nat1123abc_").equals("nat1123abc_"));
	}
	@Test
	public void NATURALDigitLetterUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("NATURAL123abc_").equals("NATURAL123abc_"));
		assertTrue(UnicodeTranslator.toAscii("natural123abc_").equals("natural123abc_"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("POW1123abc_").equals("POW1123abc_"));
		assertTrue(UnicodeTranslator.toAscii("pow1123abc_").equals("pow1123abc_"));
	}
	@Test
	public void TRUEDigitLetterUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("TRUE123abc_").equals("TRUE123abc_"));
		assertTrue(UnicodeTranslator.toAscii("true123abc_").equals("true123abc_"));
	}
	@Test
	public void UNIONDigitLetterUnderscore()
	{
		assertTrue(UnicodeTranslator.toAscii("UNION123abc_").equals("UNION123abc_"));
		assertTrue(UnicodeTranslator.toAscii("union123abc_").equals("union123abc_"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("FALSE123_abc").equals("FALSE123_abc"));
		assertTrue(UnicodeTranslator.toAscii("false123_abc").equals("false123_abc"));
	}
	@Test
	public void INTEGERDigitUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGER123_abc").equals("INTEGER123_abc"));
		assertTrue(UnicodeTranslator.toAscii("integer123_abc").equals("integer123_abc"));
	}
	@Test
	public void INTERDigitUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("INTER123_abc").equals("INTER123_abc"));
		assertTrue(UnicodeTranslator.toAscii("inter123_abc").equals("inter123_abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NAT1123_abc").equals("NAT1123_abc"));
		assertTrue(UnicodeTranslator.toAscii("nat1123_abc").equals("nat1123_abc"));
	}
	@Test
	public void NATURALDigitUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("NATURAL123_abc").equals("NATURAL123_abc"));
		assertTrue(UnicodeTranslator.toAscii("natural123_abc").equals("natural123_abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("POW1123_abc").equals("POW1123_abc"));
		assertTrue(UnicodeTranslator.toAscii("pow1123_abc").equals("pow1123_abc"));
	}
	@Test
	public void TRUEDigitUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("TRUE123_abc").equals("TRUE123_abc"));
		assertTrue(UnicodeTranslator.toAscii("true123_abc").equals("true123_abc"));
	}
	@Test
	public void UNIONDigitUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("UNION123_abc").equals("UNION123_abc"));
		assertTrue(UnicodeTranslator.toAscii("union123_abc").equals("union123_abc"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("FALSE_abc123").equals("FALSE_abc123"));
		assertTrue(UnicodeTranslator.toAscii("false_abc123").equals("false_abc123"));
	}
	@Test
	public void INTEGERUnderscoreLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGER_abc123").equals("INTEGER_abc123"));
		assertTrue(UnicodeTranslator.toAscii("integer_abc123").equals("integer_abc123"));
	}
	@Test
	public void INTERUnderscoreLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("INTER_abc123").equals("INTER_abc123"));
		assertTrue(UnicodeTranslator.toAscii("inter_abc123").equals("inter_abc123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NAT1_abc123").equals("NAT1_abc123"));
		assertTrue(UnicodeTranslator.toAscii("nat1_abc123").equals("nat1_abc123"));
	}
	@Test
	public void NATURALUnderscoreLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("NATURAL_abc123").equals("NATURAL_abc123"));
		assertTrue(UnicodeTranslator.toAscii("natural_abc123").equals("natural_abc123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("POW1_abc123").equals("POW1_abc123"));
		assertTrue(UnicodeTranslator.toAscii("pow1_abc123").equals("pow1_abc123"));
	}
	@Test
	public void TRUEUnderscoreLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("TRUE_abc123").equals("TRUE_abc123"));
		assertTrue(UnicodeTranslator.toAscii("true_abc123").equals("true_abc123"));
	}
	@Test
	public void UNIONUnderscoreLetterDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("UNION_abc123").equals("UNION_abc123"));
		assertTrue(UnicodeTranslator.toAscii("union_abc123").equals("union_abc123"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("FALSE_123abc").equals("FALSE_123abc"));
		assertTrue(UnicodeTranslator.toAscii("false_123abc").equals("false_123abc"));
	}
	@Test
	public void INTEGERUnderscoreDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("INTEGER_123abc").equals("INTEGER_123abc"));
		assertTrue(UnicodeTranslator.toAscii("integer_123abc").equals("integer_123abc"));
	}
	@Test
	public void INTERUnderscoreDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("INTER_123abc").equals("INTER_123abc"));
		assertTrue(UnicodeTranslator.toAscii("inter_123abc").equals("inter_123abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("NAT1_123abc").equals("NAT1_123abc"));
		assertTrue(UnicodeTranslator.toAscii("nat1_123abc").equals("nat1_123abc"));
	}
	@Test
	public void NATURALUnderscoreDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("NATURAL_123abc").equals("NATURAL_123abc"));
		assertTrue(UnicodeTranslator.toAscii("natural_123abc").equals("natural_123abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("POW1_123abc").equals("POW1_123abc"));
		assertTrue(UnicodeTranslator.toAscii("pow1_123abc").equals("pow1_123abc"));
	}
	@Test
	public void TRUEUnderscoreDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("TRUE_123abc").equals("TRUE_123abc"));
		assertTrue(UnicodeTranslator.toAscii("true_123abc").equals("true_123abc"));
	}
	@Test
	public void UNIONUnderscoreDigitLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("UNION_123abc").equals("UNION_123abc"));
		assertTrue(UnicodeTranslator.toAscii("union_123abc").equals("union_123abc"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_123_abc").equals("abc_123_abc"));
	}
	
	@Test
	public void LetterUnderscoreLetterUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_abc_abc").equals("abc_abc_abc"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_ANY_abc").equals("abc_ANY_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_any_abc").equals("abc_any_abc"));
	}
	@Test
	public void LetterUnderscoreFALSEUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_FALSE_abc").equals("abc_FALSE_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_false_abc").equals("abc_false_abc"));
	}
	@Test
	public void LetterUnderscoreINTEGERUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_INTEGER_abc").equals("abc_INTEGER_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_integer_abc").equals("abc_integer_abc"));
	}
	@Test
	public void LetterUnderscoreINTERUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_INTER_abc").equals("abc_INTER_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_inter_abc").equals("abc_inter_abc"));
	}
	@Test
	public void LetterUnderscoreNATUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_NAT_abc").equals("abc_NAT_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_nat_abc").equals("abc_nat_abc"));
	}
	@Test
	public void LetterUnderscoreNAT1UnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_NAT1_abc").equals("abc_NAT1_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_nat1_abc").equals("abc_nat1_abc"));
	}
	@Test
	public void LetterUnderscoreNATURALUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_NATURAL_abc").equals("abc_NATURAL_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_natural_abc").equals("abc_natural_abc"));
	}
	@Test
	public void LetterUnderscoreNOTUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_NOT_abc").equals("abc_NOT_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_not_abc").equals("abc_not_abc"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("abc_POW_abc").equals("abc_POW_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_pow_abc").equals("abc_pow_abc"));
	}
	@Test
	public void LetterUnderscorePOW1UnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_POW1_abc").equals("abc_POW1_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_pow1_abc").equals("abc_pow1_abc"));
	}
	@Test
	public void LetterUnderscoreTRUEUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_TRUE_abc").equals("abc_TRUE_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_true_abc").equals("abc_true_abc"));
	}
	@Test
	public void LetterUnderscoreUNIONUnderscoreLetter()
	{
		assertTrue(UnicodeTranslator.toAscii("abc_UNION_abc").equals("abc_UNION_abc"));
		assertTrue(UnicodeTranslator.toAscii("abc_union_abc").equals("abc_union_abc"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_123_123").equals("123_123_123"));
	}

	@Test
	public void DigitUnderscoreLetterUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_abc_123").equals("123_abc_123"));
	}
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_ANY_123").equals("123_ANY_123"));
		assertTrue(UnicodeTranslator.toAscii("123_any_123").equals("123_any_123"));
	}
	@Test
	public void DigitUnderscoreFALSEUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_FALSE_123").equals("123_FALSE_123"));
		assertTrue(UnicodeTranslator.toAscii("123_false_123").equals("123_false_123"));
	}
	@Test
	public void DigitUnderscoreINTEGERUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_INTEGER_123").equals("123_INTEGER_123"));
		assertTrue(UnicodeTranslator.toAscii("123_integer_123").equals("123_integer_123"));
	}
	@Test
	public void DigitUnderscoreINTERUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_INTER_123").equals("123_INTER_123"));
		assertTrue(UnicodeTranslator.toAscii("123_inter_123").equals("123_inter_123"));
	}
	@Test
	public void DigitUnderscoreNATUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_NAT_123").equals("123_NAT_123"));
		assertTrue(UnicodeTranslator.toAscii("123_nat_123").equals("123_nat_123"));
	}
	@Test
	public void DigitUnderscoreNAT1UnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_NAT1_123").equals("123_NAT1_123"));
		assertTrue(UnicodeTranslator.toAscii("123_nat1_123").equals("123_nat1_123"));
	}
	@Test
	public void DigitUnderscoreNATURALUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_NATURAL_123").equals("123_NATURAL_123"));
		assertTrue(UnicodeTranslator.toAscii("123_natural_123").equals("123_natural_123"));
	}
	@Test
	public void DigitUnderscoreNOTUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_NOT_123").equals("123_NOT_123"));
		assertTrue(UnicodeTranslator.toAscii("123_not_123").equals("123_not_123"));
	}
	@Test
	...
	{
		assertTrue(UnicodeTranslator.toAscii("123_POW_123").equals("123_POW_123"));
		assertTrue(UnicodeTranslator.toAscii("123_pow_123").equals("123_pow_123"));
	}
	@Test
	public void DigitUnderscorePOW1UnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_POW1_123").equals("123_POW1_123"));
		assertTrue(UnicodeTranslator.toAscii("123_pow1_123").equals("123_pow1_123"));
	}
	@Test
	public void DigitUnderscoreTRUEUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_TRUE_123").equals("123_TRUE_123"));
		assertTrue(UnicodeTranslator.toAscii("123_true_123").equals("123_true_123"));
	}
	@Test
	public void DigitUnderscoreUNIONUnderscoreDigit()
	{
		assertTrue(UnicodeTranslator.toAscii("123_UNION_123").equals("123_UNION_123"));
		assertTrue(UnicodeTranslator.toAscii("123_union_123").equals("123_union_123"));
	}
	...
	public void Var_123()
	{
		...
		assertTrue(UnicodeTranslator.toAscii("var_123_var").equals("var_123_var"));	
	...
	public void VarFALSE()
	{
		...
		assertTrue(UnicodeTranslator.toAscii("varfalse").equals("varfalse"));
		assertTrue(UnicodeTranslator.toAscii("varFALSEvar").equals("varFALSEvar"));
		assertTrue(UnicodeTranslator.toAscii("varfalsevar").equals("varfalsevar"));
		...
		assertTrue(UnicodeTranslator.toAscii("123FALSE").equals("123FALSE"));
		assertTrue(UnicodeTranslator.toAscii("123false").equals("123false"));
		assertTrue(UnicodeTranslator.toAscii("123FALSE123").equals("123FALSE123"));
		assertTrue(UnicodeTranslator.toAscii("123false123").equals("123false123"));
		assertTrue(UnicodeTranslator.toAscii("FALSE123").equals("FALSE123"));
		assertTrue(UnicodeTranslator.toAscii("false123").equals("false123"));
	...
	public void VarINTEGER()
	{
		...
		assertTrue(UnicodeTranslator.toAscii("varinteger").equals("varinteger"));
		assertTrue(UnicodeTranslator.toAscii("varINTEGERvar").equals("varINTEGERvar"));
		assertTrue(UnicodeTranslator.toAscii("varintegervar").equals("varintegervar"));
		...
		assertTrue(UnicodeTranslator.toAscii("INTEGER123").equals("INTEGER123"));
		assertTrue(UnicodeTranslator.toAscii("integer123").equals("integer123"));
		assertTrue(UnicodeTranslator.toAscii("123INTEGER123").equals("123INTEGER123"));
		assertTrue(UnicodeTranslator.toAscii("123integer123").equals("123integer123"));
	...
	public void VarINTER()
	{
		...
		assertTrue(UnicodeTranslator.toAscii("varinter").equals("varinter"));
		assertTrue(UnicodeTranslator.toAscii("varINTERvar").equals("varINTERvar"));
		assertTrue(UnicodeTranslator.toAscii("varintervar").equals("varintervar"));
		...
		assertTrue(UnicodeTranslator.toAscii("123inter").equals("123inter"));
		assertTrue(UnicodeTranslator.toAscii("123INTER").equals("123INTER"));
		assertTrue(UnicodeTranslator.toAscii("123INTER123").equals("123INTER123"));
		assertTrue(UnicodeTranslator.toAscii("123inter123").equals("123inter123"));
		assertTrue(UnicodeTranslator.toAscii("INTER123").equals("INTER123"));
		assertTrue(UnicodeTranslator.toAscii("inter123").equals("inter123"));
	...
	public void VarNATURAL()
	{
		...
		assertTrue(UnicodeTranslator.toAscii("varnatural").equals("varnatural"));
		assertTrue(UnicodeTranslator.toAscii("varNATURALvar").equals("varNATURALvar"));
		assertTrue(UnicodeTranslator.toAscii("varnaturalvar").equals("varnaturalvar"));
		...
		assertTrue(UnicodeTranslator.toAscii("123NATURAL").equals("123NATURAL"));
		assertTrue(UnicodeTranslator.toAscii("123natural").equals("123natural"));
		assertTrue(UnicodeTranslator.toAscii("123NATURAL123").equals("123NATURAL123"));
		assertTrue(UnicodeTranslator.toAscii("123natural123").equals("123natural123"));
		assertTrue(UnicodeTranslator.toAscii("NATURAL123").equals("NATURAL123"));
		assertTrue(UnicodeTranslator.toAscii("natural123").equals("natural123"));
	...
	public void VarUNION()
	{
		...
		assertTrue(UnicodeTranslator.toAscii("varunion").equals("varunion"));
		assertTrue(UnicodeTranslator.toAscii("varUNIONvar").equals("varUNIONvar"));
		assertTrue(UnicodeTranslator.toAscii("varunionvar").equals("varunionvar"));
		...
		assertTrue(UnicodeTranslator.toAscii("123UNION").equals("123UNION"));
		assertTrue(UnicodeTranslator.toAscii("123union").equals("123union"));
		assertTrue(UnicodeTranslator.toAscii("123UNION123").equals("123UNION123"));
		assertTrue(UnicodeTranslator.toAscii("123union123").equals("123union123"));
		assertTrue(UnicodeTranslator.toAscii("UNION123").equals("UNION123"));
		assertTrue(UnicodeTranslator.toAscii("union123").equals("union123"));
	...
	/* Problems:
	 * UnicodeTranslator.toAscii("p ; q") makes "p , q"
	 * 		ForwardComposition()
	 * UnicodeTranslator.toAscii("G ; H") makes "G , H"
	 * 		SequentialSubstitution()
	 * java.io.IOException: Pushback buffer overflow
	 * 		LeftOverriding(), PrependElement(), AppendElement()
	 * de.prob.unicode.lexer.LexerException: [1,4] Unknown token: _
	 * 		Var_123(), etc.
	 */
}
