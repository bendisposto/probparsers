...
'bindval'('VM','prefix'('src_span'(9,6,9,10,89,4),[],'coin','prefix'('src_span'(9,14,9,18,97,4),[],'choc','val_of'('VM','src_span'(9,22,9,24,105,2)),'src_span'(9,19,9,21,101,10)),'src_span'(9,11,9,13,93,18)),'src_span'(9,1,9,24,84,23)).
'comment'('lineComment'('-- vm2.csp'),'src_position'(1,1,0,10)).
