...
public class BSequence implements List<BObject>, BObject {
	...
	public Iterator<BObject> iterator() {
		return new BSequenceIterator(this);
	}
	...
	public boolean equals(Object o) {
		...
		BSequence bObjects = (BSequence) o;
	...
	public ListIterator<BObject> listIterator(int index) {
		return new BSequenceIterator(this, index);
	}
	...
	public BSequence(List<BObject> l) {
		this.list = l;
	}
