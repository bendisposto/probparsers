...
public class CodeGenerator {
	...
	public static void main(String[] args) throws URISyntaxException, CodeGenerationException {
		...
		codeGenerator.generate(Paths.get(CodeGenerator.class.getClassLoader().getResource("de/hhu/stups/codegenerator/testfiles/EnumSets.mch").toURI()), GeneratorMode.JAVA, true);
	}
