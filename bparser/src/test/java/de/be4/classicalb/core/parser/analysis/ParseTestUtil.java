...
public class ParseTestUtil {
	public static String parsePred(final String input) throws BException {
		return parse(BParser.PREDICATE_PREFIX + " " + input);
	}

	public static String parseExpr(final String input) throws BException {
		return parse(BParser.EXPRESSION_PREFIX + " " + input);
	}

	private static String parse(final String input) throws BException {
