...
public class Record implements BObject, Map<java.lang.String, BObject> {
	...
	public java.lang.String toString() {
		Iterator<java.util.Map.Entry<java.lang.String, BObject>> it = this.entrySet().iterator();
		StringBuffer sb = new StringBuffer();
		sb.append("rec(");
		while(it.hasNext()) {
			Map.Entry<java.lang.String, BObject> entry = (java.util.Map.Entry<java.lang.String, BObject>) it.next();
