...
public class Sequence implements List<BObject>, BObject {
	 ...
	 * call to {@link java.util.ListIterator#next next}. An initial call to
	 * {@link java.util.ListIterator#previous previous} would return the element
	 * with the specified index minus one.
	 * 
	 * @param index
	 *            index of the first element to be returned from the list
	 *            iterator (by a call to {@link java.util.ListIterator#next
	 *            next})
	 * @return a list iterator over the elements in this list (in proper
